...
public class AuthFilter implements Filter {
    ...
    public void doFilter(final ServletRequest request,
        ...
        @SuppressWarnings("unchecked")
        final List<User> users = (List<User>) req.getServletContext().getAttribute("users");
        ...
        if (nonNull(session) &&
            ...
            final User.ROLE role = dao.get().getRoleByLoginPassword(username, password);
    ...
    private void moveToMenu(final HttpServletRequest req,
        ...
        if (role.equals(User.ROLE.ADMIN)) {
            ...
            req.getRequestDispatcher("/WEB-INF/view/doctor_menu.jsp").forward(req, res);

        } else if (role.equals(User.ROLE.NURSE)) {

            req.getRequestDispatcher("/WEB-INF/view/nurse_menu.jsp").forward(req, res);
        } else {
